...
class PredefinedFlags:
    ...
    SHORT_HELP = Flag(name="H", prefix="-", possible_values=PossibleValues.NEITHER)

    INFO = Flag(name="info", possible_values=PossibleValues.NEITHER)
    SHORT_INFO = Flag(name="I", prefix="-", possible_values=PossibleValues.NEITHER)

    ALL = Flag(name="all", possible_values=PossibleValues.NEITHER)
    SHORT_ALL = Flag(name="A", prefix="-", possible_values=PossibleValues.NEITHER)
